...
const TABS: {id:Tab; label:string; hint:string}[] = [
  {id:"inputs", label:"My Profile", hint:"Enter your details"},
  {id:"results", label:"Results", hint:"Charts & numbers"},
  {id:"whatif", label:"What-If", hint:"Explore scenarios"},
  {id:"relocate", label:"Relocate", hint:"Compare states"},
];
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-5xl mx-auto px-4 py-6">
        ...
        {activeTab === "results" && (
          <ResultsDashboard results={results} profile={profile} />
        )}
        {activeTab === "whatif" && (
          <WhatIfPanel profile={profile} baseResults={results} />
        )}
        {activeTab === "relocate" && (
          <RelocationPanel profile={profile} baseResults={results} />
        )}
      </main>
